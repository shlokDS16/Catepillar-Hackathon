...
- **In flight:** Track B: B0 merged (455b317); B1 (contracts v1.0.0 + seed generator + fixtures) in progress. Track F: F01-F02 merged to main (latest a4324ba); F03 (shells, nav, SOS/Ask slots) in progress toward
